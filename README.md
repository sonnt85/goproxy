...
[![GoDoc](https://godoc.org/github.com/sonnt85/goproxy?status.svg)](https://godoc.org/github.com/sonnt85/goproxy)
[![Join the chat at https://gitter.im/sonnt85/goproxy](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/sonnt85/goproxy?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
![Status](https://github.com/sonnt85/goproxy/workflows/Go/badge.svg)
...
Get the latest goproxy from `gopkg.in/sonnt85/goproxy.v1`.
...
[the eavesdropper example](https://github.com/sonnt85/goproxy/blob/master/examples/goproxy-eavesdropper/main.go#L27)
2. Transparent proxy support for http/https including MITM certificate generation for TLS.  See the [transparent example.](https://github.com/sonnt85/goproxy/tree/master/examples/goproxy-transparent)
